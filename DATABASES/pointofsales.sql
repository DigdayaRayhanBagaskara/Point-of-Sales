...
CREATE TABLE `brands_produk`  (
  ...
  `asal_brand` varchar(255)  NULL DEFAULT NULL,
...
CREATE TABLE `discount`  (
  ...
  `discount_names` varchar(100)  NULL DEFAULT NULL,
  `discount_type` enum('amount','%')  NULL DEFAULT NULL,
...
CREATE TABLE `produk`  (
  ...
  `produk_name` varchar(100)  NULL DEFAULT NULL,
  `gambar_produk` varchar(100)  NULL DEFAULT NULL,
...
CREATE TABLE `produk_categories`  (
  ...
  `categories_name` varchar(100)  NULL DEFAULT NULL,
...
CREATE TABLE `produk_variant`  (
  ...
  `sku` char(100)  NULL DEFAULT NULL,
...
CREATE TABLE `role`  (
  ...
  `nama_role` varchar(100)  NULL DEFAULT NULL,
...
CREATE TABLE `transaksi`  (
  ...
  `nomor_transaksi` varchar(255)  NULL DEFAULT NULL,
  `id_discount` int NULL DEFAULT NULL,
